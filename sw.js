...
const APP_SHELL = [
  ...
  new URL('shared/modules/p4-p5-import.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/internal-organization.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/p5-snapshots.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/finance-store.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/finance-service.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/finance-recurring.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/core.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/reminders-core.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/reminders-view.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/notes-view.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/notes-content.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/notes-detail.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/notes-editor.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/safe-markdown.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/diary-view.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/diary-editor.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/diary-detail.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/rules-view.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/search-view.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/modules/onboarding-view.js?v=' + VERSION, APP_ROOT).toString(),
  ...
  new URL('shared/modules/tracker-view.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/online/presence.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/online/realtime.js?v=' + VERSION, APP_ROOT).toString(),
  new URL('shared/online/sync.js?v=' + VERSION, APP_ROOT).toString(),
